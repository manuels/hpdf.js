(function() {
  ...
  Font = (function() {
    ...
    Font.prototype.fontName = function() {
      return ccall(this.doc, 'HPDF_Font_GetFontName', 'string', ['number'], [this.font]);
    };
  ...
  Outline = (function() {
    ...
    function Outline(doc, outline) {
      this.doc = doc;
      this.outline = outline;
    }

    Outline.prototype.setDestination = function(dst) {
      return ccall(this.doc, 'HPDF_Outline_SetDestination', 'number', ['number', 'number'], [this.outline, dst.dst]);
    };

    Outline.prototype.setOpened = function(is_open) {
      return ccall(this.doc, 'HPDF_Outline_SetOpened', 'number', ['number', 'number'], [this.outline, is_open ? 1 : 0]);
    };
  ...
  Page = (function() {
    ...
    Page.prototype.currentTextPos = function() {
      var ptr;
      ptr = Module['allocate']([123, 321], 'float', ALLOC_NORMAL);
      ccall(this.doc, 'HPDF_Page_GetCurrentTextPos', 'number', ['number', 'number'], [ptr, this.page]);
      console.log(ptr);
      return {
  ...
  HPDF = (function() {
    ...
    HPDF.prototype.useJPEncodings = function() {
      return ccall(this, 'HPDF_UseJPEncodings', 'number', ['number'], [this.hpdf]);
    };

    HPDF.prototype.useJPFonts = function() {
      return ccall(this, 'HPDF_UseJPFonts', 'number', ['number'], [this.hpdf]);
    };

    HPDF.prototype.setPageMode = function(mode) {
      var id;
      ...
      return ccall(this, 'HPDF_SetPageMode', 'number', ['number', 'number'], [this.hpdf, id]);
    };
    ...
    HPDF.prototype.createOutline = function(parent, title, encoder) {
      var ret;
      ret = ccall(this, 'HPDF_CreateOutline', 'number', ['number', 'number', 'string', 'number'], [this.hpdf, parent, title, encoder != null ? encoder.encoder : void 0]);
